  ...
  HR = {
    ...
    pageState: {
      ...
      bio: function() {
        ...
        $('.ad-module').removeClass('fade-out-up');
	  ...
	  cinematography: function() {
        console.log('cinematography state notified');
        document.querySelector('body').classList.add('cinematography-page');
        HR.transitionContent('cinematography');
        $('.ad-module').addClass('fade-out-up');
